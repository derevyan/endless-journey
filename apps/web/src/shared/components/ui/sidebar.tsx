 ...
 * Returns the boolean value if the cookie exists, null otherwise.
 */
function readSidebarStateFromCookie(): boolean | null {
  ...
  for (const cookie of cookies) {
    ...
    if (name === SIDEBAR_COOKIE_NAME) {
      // Cookie value is stored as "true" or "false" string
      return value === "true";
    }
  }
  return null;
...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  // Read cookie value on initialization - user preference takes precedence over defaultOpen
  const cookieValue = React.useMemo(() => readSidebarStateFromCookie(), []);
